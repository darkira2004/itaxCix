...
class ProfileController {
    // Constante para el avatar por defecto (evita duplicación)
     ...
     */
    setDefaultProfileImage() {        try {
            // Verificar que ProfileService esté disponible
            if (!this.profileService) {
                console.warn('⚠️ ProfileService no disponible, usando URL por defecto hardcoded');
                this.setProfileImage(ProfileController.DEFAULT_AVATAR_URL);
                return;
            }
     ...
     */    getDefaultAvatarUrl() {
        ...
        // Fallback hardcoded
        return ProfileController.DEFAULT_AVATAR_URL;
    }
